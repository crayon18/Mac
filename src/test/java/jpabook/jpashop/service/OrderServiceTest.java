...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        Book book = createBook("시골 쥐", 10000, 10);
    ...
    public void 주문취소() throws Exception{
        ...
        Member member = createMember();
        Book item = createBook("시골 쥐", 10000, 10);
        ...
        assertEquals("주문 취소시 상태는 CANCEL 이다다", OrderStatus.CANCEL, getOrder.getStatus());
    ...
    public void 재고수량초과() throws Exception{
        ...
        Member member = createMember();
        Item item = createBook("시골 쥐", 10000, 10);
